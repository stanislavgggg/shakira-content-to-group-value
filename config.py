...
# Минимальная длина текста. Спортивные фиды отдают огрызки в 1-2 предложения,
# поэтому для них порог ниже — недостающее дотягиваем со страницы статьи.
MIN_BODY = {"sports": 140, "casino": 220, "industry": 220, "gaming": 200}

# Сколько статей за прогон разрешено дотянуть со страницы (HTTP-запрос на каждую)
ENRICH_LIMIT = 22
